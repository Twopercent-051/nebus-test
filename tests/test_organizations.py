...
#     async def test_found(self):
#         expected_title = 'ООО "Ромашка"'
#         organizations = await OrganizationsService.get_in_bounding_box(min_lat=55.750244, max_lat=55.752244, min_lng=37.617423, max_lng=37.619423
#
#
# )
#         assert organizations.data
...
#     @pytest.mark.asyncio
#     async def test_not_found(self):
#         organizations = await OrganizationsService.get_in_bounding_box(min_lat=56.750244, max_lat=57.752244,
#                                                                        min_lng=37.617423, max_lng=37.619423
#
#                                                                        )
#
#         assert organizations.data is None
...
#     async def test_found(self):
#         expected_title = 'ООО "Ромашка"'
#         organizations = await OrganizationsService.get_in_radius(center_lat = 55.751244,
